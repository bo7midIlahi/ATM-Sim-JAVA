...
public class WithdrawWindow extends JPanel {
    ...
    public WithdrawWindow(MainWindow mainWindow, Long cardNumber) {
        ...
        // Title
        JLabel titleLabel = mainWindow.createLabel("WITHDRAW FUNDS", 30);
        ...
        JButton depositButton = new JButton("Confirm Withdraw");
    ...
    private void handleDeposit(ActionEvent e) {
        ...
        try {
            ...
            if (currentBalance>amount) {
                ...
                JOptionPane.showMessageDialog(this,
                    "You Don't Have That Amount Of Money, PEASANT",
                    "Success",
                    JOptionPane.INFORMATION_MESSAGE);
            }
